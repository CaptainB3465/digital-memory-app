...
const MemoryForm = ({ onSubmit, onCancel, initialData, collections }) => {
  ...
  return (
    <div className="flex flex-col h-full bg-slate-50/50 backdrop-blur-xl">
      <header className="px-12 py-10 bg-white/80 backdrop-blur-md border-b border-white/40 flex items-center justify-between sticky top-0 z-20 shadow-sm">
        ...
        <button 
          onClick={onCancel} 
          className="p-3 bg-white/50 hover:bg-white hover:shadow-md transition-all rounded-2xl text-slate-400 hover:text-indigo-600 border border-white/60 group"
        >
            ...
            <div className="lg:col-span-7 space-y-10">
              <div className="space-y-3 group">
                ...
                <input
                  ...
                  className="w-full bg-white/80 backdrop-blur-sm border border-slate-200 rounded-3xl px-6 py-5 focus:ring-4 focus:ring-indigo-600/5 focus:border-indigo-600/20 transition-all outline-none font-bold text-slate-800 text-lg placeholder:text-slate-300 shadow-sm"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="space-y-3 group">
                  ...
                  <div className="relative">
                    ...
                    <input
                      type="date"
                      className="w-full bg-white/80 backdrop-blur-sm border border-slate-200 rounded-3xl pl-14 pr-6 py-4.5 focus:ring-4 focus:ring-indigo-600/5 focus:border-indigo-600/20 outline-none font-bold text-slate-700 shadow-sm"
                      value={formData.date}
              ...
              <div className="space-y-3 group">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-white/80 backdrop-blur-sm border border-slate-200 rounded-3xl pl-14 pr-8 py-4.5 focus:ring-4 focus:ring-indigo-600/5 focus:border-indigo-600/20 outline-none font-bold text-slate-700 placeholder:text-slate-300 shadow-sm"
              ...
              <div className="space-y-3 group">
                ...
                <div className="flex flex-wrap gap-3 p-5 bg-white/80 backdrop-blur-sm border border-slate-200 rounded-3xl min-h-[72px] shadow-sm transition-all focus-within:ring-4 focus-within:ring-indigo-600/5 focus-within:border-indigo-600/20">
                  ...
                  <input
                    type="text"
                    placeholder="+ Add tag..."
                    className="flex-1 min-w-[140px] outline-none text-sm font-bold text-slate-700 bg-transparent placeholder:text-slate-300"
                    value={newTag}
            ...
            <div className="lg:col-span-5 space-y-10">
              <div className="space-y-3 group">
                ...
                <textarea
                  ...
                  className="w-full bg-white/80 backdrop-blur-sm border border-slate-200 rounded-3xl px-7 py-6 focus:ring-4 focus:ring-indigo-600/5 focus:border-indigo-600/20 outline-none font-semibold text-slate-700 h-[320px] resize-none leading-relaxed placeholder:text-slate-300 shadow-sm text-lg"
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between px-1">
                   ...
                   <span className="text-[10px] bg-slate-100 text-slate-500 font-black px-3 py-1 rounded-full">{formData.images.length} Captured</span>
                </div>
                ...
                <div className="grid grid-cols-2 gap-5">
                      ...
                      >
                        ...
                        <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                          <button
                            ...
                            className="p-3 bg-white text-rose-500 rounded-2xl shadow-2xl transform scale-75 group-hover:scale-100 transition-all duration-300 hover:bg-rose-50"
                          >
                            <Trash2 size={20} />
                          </button>
                        </div>
                  ...
                  <label className="h-40 rounded-3xl border-2 border-dashed border-slate-200 hover:border-indigo-600/50 hover:bg-indigo-50/30 cursor-pointer flex flex-col items-center justify-center gap-3 transition-all group shadow-sm bg-white/40">
                    <div className="w-12 h-12 bg-white rounded-2xl flex items-center justify-center text-slate-400 group-hover:bg-indigo-600 group-hover:text-white group-hover:shadow-lg group-hover:shadow-indigo-500/30 transition-all duration-500">
                      <Plus size={24} />
                    </div>
      ...
      <footer className="px-12 py-10 bg-white/80 backdrop-blur-md border-t border-white/40 flex items-center justify-end gap-6 sticky bottom-0 z-20 shadow-[0_-4px_30px_rgba(0,0,0,0.03)]">
        <button
          onClick={onCancel}
          className="px-8 py-4 text-[11px] font-black text-slate-400 uppercase tracking-[0.2em] hover:text-slate-600 transition-colors"
        >
          Discard Entry
        </button>
        <button
