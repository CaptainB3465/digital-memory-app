    ...
    <AuthLayout quotes={quotes} currentQuoteIndex={0}>
      ...
      >
        <button 
          ...
          className="mb-8 w-10 h-10 rounded-full bg-white/50 border border-slate-200 flex items-center justify-center text-slate-400 hover:text-indigo-600 hover:bg-white hover:shadow-md transition-all group"
        >
          <ArrowLeft size={18} className="group-hover:-translate-x-1 transition-transform" />
        </button>

        <div className="mb-10">
          <h2 className="text-3xl font-display font-black text-slate-800 tracking-tight">Reset Password</h2>
